  ...
  return (
    <main className="min-h-screen bg-[#f9f7f2] px-6 py-10">
      <div className="mx-auto max-w-md">
        <Link
          href="/"
          className="mb-12 inline-flex items-center gap-2 text-sm text-[#777c78]"
        >
          <ArrowLeft size={16} />
          Back to Festyvibe
        </Link>
        ...
        <div className="rounded-[2rem] border border-[#ebe8e1] bg-white p-7 shadow-sm md:p-9">
          ...
          <form onSubmit={handleSubmit} className="mt-8 space-y-4">
            <input
              className="w-full rounded-2xl border border-[#dedbd4] px-4 py-3.5 outline-none focus:border-[#193c32]"
              type="email"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full rounded-2xl bg-[#193c32] py-3.5 font-medium text-white transition hover:bg-[#102d25] disabled:cursor-not-allowed disabled:opacity-60"
            >
          ...
          <p className="mt-6 text-center text-sm text-[#777c78]">
            ...
            <Link
              href="/register"
              className="font-medium text-[#193c32]"
            >
              Create one
            </Link>
          </p>
