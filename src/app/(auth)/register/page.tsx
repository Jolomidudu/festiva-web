      ...
      <div className="mx-auto max-w-md">
        ...
        <div className="rounded-[2rem] border border-[#ebe8e1] bg-white p-7 shadow-sm md:p-9">
          ...
          <form className="mt-8 space-y-4">
            <input className="w-full rounded-2xl border border-[#dedbd4] px-4 py-3.5 outline-none focus:border-[#193c32]" placeholder="Full name" />
            ...
            <button className="w-full rounded-2xl bg-[#193c32] py-3.5 font-medium text-white">Create account</button>
          </form>
          <p className="mt-6 text-center text-sm text-[#777c78]">
            Already have an account? <Link href="/login" className="font-medium text-[#193c32]">Sign in</Link>
          </p>
        </div>
      </div>
    </main>
